...
const p = {
  ...
  left: { fontSize: 30 * r, s: 45 * r, e: 200 * r, top: 100 * r },
  right: { fontSize: 30 * r, s: 50 * r, e: 200 * r, top: 180 * r },
};
var delta = 300;
...
async function init() {
  ...
  const ringGLTF = await new GLTFLoader().loadAsync("../assets/ring35.glb");
