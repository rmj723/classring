...
const p = {
  inside: { fontSize: 30 * r, s: 0, e: 450 * r, left: 0, top: 40 * r },
  left: { fontSize: 34 * r, s: 20 * r, e: 250 * r, top: 105 * r },
  right: { fontSize: 34 * r, s: 40 * r, e: 260 * r, top: 185 * r },
};
var delta = 300;
...
async function init() {
  ...
  const ringGLTF = await loader.loadAsync("../assets/ring38.glb");
