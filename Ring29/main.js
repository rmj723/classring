...
var charPos = { top1: [], top2: [], right: [], left: [], inside: [] };
var ring = {
  body: null,
  material: null,
  textures: {},
...
var ctx,
  overflow = {};
const p = { inside: { fontSize: 27, s: 0, e: 410, left: 0, top: 58 } };
var delta = 300;
...
async function init() {
  ...
  const ringGLTF = await new GLTFLoader().loadAsync("../assets/ring29.glb");
